...
export const SubmitReview: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    console.log('>>> SubmitReview - Form data:', formData);
    ...
    <div className="max-w-2xl">
      ...
      <Card>
        <p className="text-gray-600 mb-6">
          Share your experience working with a recruiter or organization. Your feedback helps
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <Input
            ...
            type="number"
            placeholder="Enter the user ID of the recruiter"
          ...
          <div>
            ...
            <div className="flex items-center space-x-1">
              ...
              <span className="ml-3 text-sm text-gray-600">
                {parseInt(formData.rating)} out of 5 stars
              </span>
            </div>
          </div>
